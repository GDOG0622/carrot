export function initThemeSettings(
    ...
    const defaultTheme = {
        ...
        '--cip-accent-hover-color': '#ff7f50',
        '--cip-insert-text-color': '#333333',
    ...
    function applyTheme(theme) {
        ...
        themeToApply['--cip-accent-hover-color'] =
            themeToApply['--cip-accent-color'];
        themeToApply['--cip-insert-text-color'] =
            themeToApply['--cip-text-color'];
    ...
    colorInputList.forEach((input) => {
        input.addEventListener('input', (e) => {
            ...
            if (property === '--cip-text-color') {
                documentRef.documentElement.style.setProperty(
                    '--cip-insert-text-color',
                    value,
                );
            }
        });
